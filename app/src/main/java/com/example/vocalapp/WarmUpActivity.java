...
/**
 * Activity for displaying list of Warm-Up Exercises
 *
 * This class creates, fills, and displays a list of the Warm-Up exercises available and initializes
...
public class WarmUpActivity extends AppCompatActivity {
    ...
    String displayNames[] = {"No-No", "Oh Sigh", "One, One-Two-One"};

    /** The name of each file associated with each menu item. */
    String fileNames[] = {"no_no", "oh_sigh", "one_one_two_one"};
